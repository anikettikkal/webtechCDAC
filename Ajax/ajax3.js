const apikey = "87f78dd0ca2e57e2e28ab3a42f14a77d";
...
document.querySelector('button').onclick = () => {
    ...
    const apiPath = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${apikey}&units=metric`;
    ...
    xhr.onreadystatechange = () => {
        ...
        if (xhr.readyState == 4 && xhr.status == 200) {
            ...
            //     div.append(img, h2, p);
                 document.getElementById("countryList").innerHTML = result.main.temp + "°C";
            // });
        }
    }
